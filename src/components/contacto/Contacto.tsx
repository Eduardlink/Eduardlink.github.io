...
const Contacto: React.FC = () => {
  ...
  const sendEmail = (e: FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      .sendForm('service_qp7eehe', 'template_h0hqr48', formRef.current, 'jD1JChGifv9VF5wjW')
      .then(
        () => {
          setSuccess(true);
          setError(false);
  ...
  return (
    <motion.div className="contactame" ref={ref} variants={variantes} initial="initial" whileInView="animate">
      <motion.div className="contenedorContacto" variants={variantes}>
      ...
      <motion.div className="contacto" variants={variantes}>
        <motion.div className="texto" variants={variantes}>
          <motion.div className="item" variants={variantes}>
            <h2>Correo electrónico</h2>
            <ClipboardCopy copyText="eduardo_pila@outlook.com"></ClipboardCopy>
          </motion.div>
          <motion.div className="item" variants={variantes}>
            <h2>Dirección</h2>
            <ClipboardCopy copyText="Ambato, Ecuador"></ClipboardCopy>
          </motion.div>
        </motion.div>
        <motion.div className="formulario">
          <motion.div
            className="telefonoSvg"
            initial={{ opacity: 1 }}
